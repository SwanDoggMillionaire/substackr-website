...
function ProExample() {
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <p className="text-center text-sm text-gray-400 mt-6">
        Audit your own Substack — free during beta, no account needed. <a href="/audit" className="text-brand-orange hover:text-brand-orange-dark font-medium transition-colors">Try it now →</a>
      </p>
    </div>
  )
}
