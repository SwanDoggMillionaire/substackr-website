...
Topics are processed top-to-bottom. The agent picks the first PENDING row, publishes it, then marks it DONE.
Edit freely — add new topics at the bottom or reorder to prioritise.

**Statuses:** PENDING (next to publish) | DONE (published) | SKIP (defer, try again later)
